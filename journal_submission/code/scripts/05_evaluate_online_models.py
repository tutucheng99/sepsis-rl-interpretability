...
# gym-sepsis is in journal_submission/gym-sepsis/, not code/gym-sepsis/
sys.path.insert(0, str(project_root.parent / "gym-sepsis"))
...
def load_your_baseline_results():
    ...
    # project_root is code/, baseline results are in journal_submission/results/
...
def main():
    ...
    # project_root is code/, so models are in project_root/models/
    models_dir = project_root / "models"
    models_to_evaluate = {
        'DDQN-Attention': models_dir / "ddqn_online_att_model_final.d3",
        'DDQN-Residual': models_dir / "ddqn_online_res_model_final.d3",
        'SAC': models_dir / "sac_online_model_final.d3"
    }
    ...
    if yalun_results:
        ...
        # project_root is code/, results are in journal_submission/results/
        results_file = project_root.parent / "results" / "yalun_models_evaluation.pkl"
